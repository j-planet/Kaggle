...
if __name__=='__main__':
    ...
    pipe_class, params_class = classifierPipes(simple=simple, name=name, usePCA=False, useRF=False)
    pipe_reg, params_reg = regressorPipes(simple=simple, usePCA=False, useRF=False)
    ...
    # #  predict
    # dt = datetime.now()
    # predictions = bestPipe.predict(testData)
