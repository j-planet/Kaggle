...
# ---------- read in data
smallTrainX, smallTrainY, _ = make_data("/home/jj/code/Kaggle/Loan Default Prediction/Data/modSmallTrain.csv")
...
gscv = GridSearchCV(pipe, allParamsDict, loss_func=mean_absolute_error, n_jobs=23, cv=5, verbose=5)
dt = datetime.now()
...
# ----------  predict
testData, notUsed, testDataIds = make_data("/home/jj/code/Kaggle/Loan Default Prediction/Data/modTest.csv")
pred = bestPipe.predict(testData)                    # predict
